...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/2.7.12-SNAPSHOT/reference/htmlsingle/#io.webservices)
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/2.7.12-SNAPSHOT/reference/htmlsingle/#data.nosql.mongodb)
* [Embedded MongoDB Database](https://docs.spring.io/spring-boot/docs/2.7.12-SNAPSHOT/reference/htmlsingle/#data.nosql.mongodb.embedded)
